...
$desc           = "DTEHM Membership";
$type           = "MERCHANT";                       // default value = MERCHANT 

$reference = "dtehm".getRandomString($n);                  // unique order id of the transaction, generated by merchant
...
$callback_url = 'http://localhost/dtehm/pay/membership-ipn.php';
...
if (isset($_GET['action'])){
    ...
    $sql = "INSERT INTO memberships (member, amount, ref, date, status)
    VALUES ('$member', '$amount', '$reference', '$date', '$status')";
...
<?php
       ...
       echo "<p class='text-subtitle text-muted'>"."Something Went wrong"."</p>";
    }
